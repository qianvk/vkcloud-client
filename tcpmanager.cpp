...
TcpMgr::TcpMgr():_host(""),_port(0),_b_recv_pending(false),_message_id(0),_message_len(0)
{
    ...
    QObject::connect(&_socket, &QTcpSocket::readyRead, [&]() {
        ...
        forever {
            ...
            handleMsg(RequestId(_message_id),_message_len, messageBody);
        }
...
void TcpMgr::initHandlers()
{
    ...
    _handlers.insert(RequestId::ID_CHAT_LOGIN_RSP, [this](RequestId id, int len, QByteArray data){
        Q_UNUSED(len);
    ...
    _handlers.insert(RequestId::ID_SEARCH_USER_RSP, [this](RequestId id, int len, QByteArray data) {
        Q_UNUSED(len);
    ...
    _handlers.insert(RequestId::ID_NOTIFY_ADD_FRIEND_REQ, [this](RequestId id, int len, QByteArray data) {
        Q_UNUSED(len);
        qDebug() << "handle id is " << static_cast<int>(id) << " data is " << data;
        // 将QByteArray转换为QJsonDocument
        QJsonDocument jsonDoc = QJsonDocument::fromJson(data);
    ...
    _handlers.insert(RequestId::ID_NOTIFY_AUTH_FRIEND_REQ, [this](RequestId id, int len, QByteArray data) {
        Q_UNUSED(len);
        qDebug() << "handle id is " << static_cast<int>(id) << " data is " << data;
        // 将QByteArray转换为QJsonDocument
        QJsonDocument jsonDoc = QJsonDocument::fromJson(data);
    ...
    _handlers.insert(RequestId::ID_ADD_FRIEND_RSP, [this](RequestId id, int len, QByteArray data) {
        Q_UNUSED(len);
        qDebug() << "handle id is " << static_cast<int>(id) << " data is " << data;
        // 将QByteArray转换为QJsonDocument
        QJsonDocument jsonDoc = QJsonDocument::fromJson(data);
    ...
    _handlers.insert(RequestId::ID_AUTH_FRIEND_RSP, [this](RequestId id, int len, QByteArray data) {
        Q_UNUSED(len);
        qDebug() << "handle id is " << static_cast<int>(id) << " data is " << data;
        // 将QByteArray转换为QJsonDocument
        QJsonDocument jsonDoc = QJsonDocument::fromJson(data);
    ...
    _handlers.insert(RequestId::ID_TEXT_CHAT_MSG_RSP, [this](RequestId id, int len, QByteArray data) {
        Q_UNUSED(len);
        qDebug() << "handle id is " << static_cast<int>(id) << " data is " << data;
        // 将QByteArray转换为QJsonDocument
        QJsonDocument jsonDoc = QJsonDocument::fromJson(data);
    ...
    _handlers.insert(RequestId::ID_NOTIFY_TEXT_CHAT_MSG_REQ, [this](RequestId id, int len, QByteArray data) {
        Q_UNUSED(len);
        qDebug() << "handle id is " << static_cast<int>(id) << " data is " << data;
        // 将QByteArray转换为QJsonDocument
        QJsonDocument jsonDoc = QJsonDocument::fromJson(data);
